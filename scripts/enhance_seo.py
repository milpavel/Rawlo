...
# Social artwork is intentionally unified in V14 and is generated by finalize_social_seo.py.
...
for code in META:
    ...
    title,desc,headline,strap=META[code]; canonical=url_for(code); image=f'{BASE}/assets/social/rawlo-social-share-v14.jpg'
...
report={'languages':len(META),'unified_social_preview':1,'country_hreflang_targets':len(COUNTRY_HREF),'features':['localized title and meta description','canonical URLs','language + country hreflang','Open Graph','X/Twitter cards','one unified 1200x630 RAWLO social image across all locales','JSON-LD Organization/WebSite/SoftwareApplication','multilingual sitemap','robots indexing directives']}
